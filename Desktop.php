...
<body style="background-image: url('img/BG_1.png'); background-size: cover; overflow:hidden;"class="pixelated">
    
    <div class="relative flex justify-center items-center w-full min-h-screen">
